      ...
      >
        ...
        <nav className="flex flex-col mt-2">
         <div className="flex flex-col text-white items-center justify-center p-6 pb-10">
            ...
            <h2 className="font-sans p-3 text-xl text-white uppercase" >{username}</h2>
         </div>
          <a
            href="/home"
            className="flex items-center p-4 text-[#D8FFFB] font-medium hover:text-[#00DAC6]"
          >
            <svg
            ...
            <span className="text-[#D8FFFB] p-4 hover:text-[#00DAC6] hover:bg-opacity-90">
              Dashboard
            </span>
          </a>
          <a
            href="/expenses"
            className="flex items-center p-4 text-[#D8FFFB] font-medium hover:bg-opacity-50 e hover:text-[#00DAC6]"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            ...
            <span className="p-4">Expenses</span>
          </a>
          <a
            href="/trips"
            className="flex items-center p-4 text-[#D8FFFB] font-medium hover:text-[#00DAC6]"
        ...
        <div className="flex pt-16 justify-center items-end align-bottom">
          <a href="
          /home">
                      <img className="w-full"  src="./logo2.png" alt="" />
